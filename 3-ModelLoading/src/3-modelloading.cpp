...
int main()
{
	...
	const char* objectVSPath = "3-ModelLoading/src/objectVS.glsl";
	const char* objectFSPath = "3-ModelLoading/src/objectFS.glsl";
	Shader objectShader(objectVSPath, objectFSPath);
	unsigned int texture1, texture2;
	//setupTextures(&texture1, &texture2);

	const char* lightVSPath = "3-ModelLoading/src/lightVS.glsl";
	const char* lightFSPath = "3-ModelLoading/src/lightFS.glsl";
	...
	const char* modelPath = "Resources/3Dmodels/backpack/backpack.obj";
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, 0.f, glm::vec3(1.0f, 0.0f, 0.0f));
